...
**In progress:** The mouse was at 69% and still charging at 16:00, so the first charge estimate is unscored; the diagnostics still write to real app data; whether the 23:00 reminder banner was seen is unanswered.
**Next session should:** Replay the charge estimates against the moment the mouse reached 100%, and append 50% → 100% to `docs/reference/charge-curve-2026-09-18.txt`.
